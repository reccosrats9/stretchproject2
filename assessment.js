...
var adjustCount= {
  ...
  downVote:function(num1){return num1-1}
};
// CODE HERE

// #5 Create an array called 'myFriends' with four of your friends names

var myFriends= ["Amber","Brie","Sergio","Linds"];
...
var trueFriends= peopleIknow.filter(function(value, index, array){if (value.friend== true){return value.name}}).map(function(value, index, array){return value.name});
